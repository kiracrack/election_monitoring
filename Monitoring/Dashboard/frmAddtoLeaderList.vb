...
Public Class frmAddtoLeaderList
    ...
    Public Sub filter()
        LoadXgrid("select  votersid ,precinct as 'Precinct No.',if(Cluster=0,'NONE',cluster) as 'Cluster', Fullname as 'Voter''s',bdate as 'Birtdate', Sex, Address, " _
                                    ...
                                    + " votersid <> '" & votersid.Text & "' and leaderid = '0' and isleader =  0 and deceased=0 order by fullname asc", "tblvoters", Em, GridView1, Me)
        ...
        Try
            ...
            For I = 0 To GridView1.SelectedRowsCount - 1
                ...
                If globalautocolorleadersmember = True Then
                    com.CommandText = "update tblvoters set leaderid='" & votersid.Text & "',colorcode='" & colorcode.Text & "', isedited=1,editedby='" & globaluserid & "' where votersid='" & toUpdate & "'" : com.ExecuteNonQuery()
                Else
                    com.CommandText = "update tblvoters set leaderid='" & votersid.Text & "',colorcode='" & globaldefcolorMember & "', isedited=1,editedby='" & globaluserid & "' where votersid='" & toUpdate & "'" : com.ExecuteNonQuery()
                End If
